  ...
  <div class="header__shipping">
                        <ul class="header__shipping--wrapper d-flex">
                            <li class="header__shipping--text text-white">مرحبا بكم في متجرنا</li>
                        </ul>
                    </div>
    ...
    <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                ...
                                <div class="dropdown__language">
                                    <ul>
                                        <li class="language__items"><a class="language__text" href="tel:920009692" dir="auto" href="/contact-us" >
                                            <i class='bx bxs-phone'></i> اتصل بنا</a></li>
                                        <li class="language__items"><a  href="mailto:wecare@arabianoud.com.sa" class="language__text" href="#">
                                            <i class='bx bxs-envelope' ></i> راسلنا</a></li>
                                        <li class="language__items"><a  href='contact'class="language__text" href="#">
                                            <i class='bx bxl-telegram' ></i> ارسال التعليقات</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="header__search--widget header__sticky--none d-none d-lg-block">
                        <form class="d-flex header__search--form" action="#">
                            <div class="header__search--box">
                                <label>
                                    <input class="header__search--input" placeholder="أخبرنا عن ماذا تبحث" type="text">
                                </label>
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                <li class="header__menu--items mega__menu--items style2">
                                    <a class="header__menu--link" href="shop.html">عطور العربية للعود
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.html">عطور رجالية </a></li>
                                        ...
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.html">عطور النساء</a></li>
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                <li class="header__menu--items mega__menu--items">
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            {{-- <span class="header__mega--subtitle">Column </span> --}}
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.html">عطور رجالية </a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-right-sidebar.html">عطور شرقية</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-grid.html">عطور الأطفال</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.html">عطور النساء</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-video.html">عطور غربية</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.html">عطور الشتاء</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account.html">عطور للجنسين</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account-2.html">عطور مزيج شرقي وغربي </a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">

                                            <img class="main__logo--img" src="assets/img/menu/1.jpg" alt="logo-img">

                                        </li>
                                    </ul>
                                </li>
                                 <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="shop.html">العود و البخور
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop.html">العود</a></li>
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="shop-right-sidebar.html">المبثوث الفاخر</a></li>

                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.html">العود بالجملة</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account.html">المعجون</a></li>

                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                           <img class="main__logo--img" src="assets/img/menu/2.jpg" alt="logo-img">
                                        </li>
                                    </ul>
                                </li>
                                 <li class="header__menu--items">
                                    <a class="header__menu--link" href="about.html">شنط و إكسسورات</a>
                                </li>
                                 <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="shop.html"> زيوت عطرية
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path  d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                        </svg>
                                    </a>
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            <span class="header__mega--subtitle">دهن العود</span>
                                            <ul class="header__mega--sub__menu"></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <span class="header__mega--subtitle">مخلطات العربية</span>
                                            <ul class="header__mega--sub__menu">
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <span class="header__mega--subtitle">زيوت عطرية</span>
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="my-account.html">عنبر</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <img class="main__logo--img" src="assets/img/menu/3.png" alt="logo-img">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="about.html">معقمات ومعطرات  </a>
                                </li>

                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="about.html">عطور الشعر</a>
                                </li>

                            </ul>
                        </nav>
                    </div>
                    <p class="header__discount--text"><img class="header__discount--icon__img"  src="assets/img/icon/lamp.png" alt="lamp-img">   تخفيضات 50% </p>
                </div>
            </div>
        </div>
