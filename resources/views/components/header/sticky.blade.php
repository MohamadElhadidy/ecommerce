                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="header__search--widget header__sticky--none d-none d-lg-block">
                        <form class="d-flex header__search--form" action="#">
                            <div class="header__search--box">
                                <label>
                                    <input class="header__search--input" placeholder="أخبرنا عن ماذا تبحث"
                                        type="text">
                                </label>
                    ...
                    <div class="header__account header__sticky--none">
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443"
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                <li class="header__menu--items mega__menu--items style2">
                                    <a class="header__menu--link" href="shop.html">عطور الخليجية للعود
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                ...
                                                <li class="header__mega--sub__menu_li"><a
                                                        class="header__mega--sub__menu--title"
                                                        href="shop-grid.html">عطور الأطفال</a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                ...
                                                <li class="header__mega--sub__menu_li"><a
                                                        class="header__mega--sub__menu--title"
                                                        href="product-video.html">عطور غربية</a></li>
                                                <li class="header__mega--sub__menu_li"><a
                                                        class="header__mega--sub__menu--title"
                                        ...
                                        <li class="header__mega--menu__li">
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a
                                                        class="header__mega--sub__menu--title"
                                                        href="my-account.html">عطور للجنسين</a></li>
                                                <li class="header__mega--sub__menu_li"><a
                                                        class="header__mega--sub__menu--title"
                                                        href="my-account-2.html">عطور مزيج شرقي وغربي </a></li>
                                            </ul>
                                        </li>
                                        <li class="header__mega--menu__li">
                                ...
                                <li class="header__mega--menu__li">
                                    ...
                                    <ul class="header__mega--sub__menu">
                                        <li class="header__mega--sub__menu_li"><a
                                                class="header__mega--sub__menu--title" href="my-account.html">عنبر</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="header__mega--menu__li">
