        ...
        <div class="offcanvas__stikcy--toolbar">
            <ul class="d-flex justify-content-between">
                ...
                <li class="offcanvas__stikcy--toolbar__list ">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">ابحث</span>
                    </a>
                </li>
                <li class="offcanvas__stikcy--toolbar__list">
                    <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="#">
                        <span class="offcanvas__stikcy--toolbar__icon">
                ...
                <li class="offcanvas__stikcy--toolbar__list">
                    <a class="offcanvas__stikcy--toolbar__btn" href="wishlist.html">
                        ...
                        <span class="offcanvas__stikcy--toolbar__label">المفضلة</span>
                        <span class="items__count">3</span>
                    </a>
                </li>
            </ul>
