<div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle">عطور النساء</span>
                                            <h4 class="product__items--content__title"><a href="product-details.html">ديزني - ياسمينا، للأطفال 30 مل</a></h4>
                                            <div class="product__items--price">
                                                <span class="current__price">109.25 ر.س</span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">218.50 ر.س</span>
                                            </div>
