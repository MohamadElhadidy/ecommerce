 ...
 <section class="contact__section section--padding color-scheme-2">
     <div class="container-fluid">
         <div class="section__heading text-center mb-50">
             <h2 class="section__heading--maintitle style2">تواصل معنا</h2>
         </div>
         <div class="contact__section--inner">
             <div class="row">
                 <div class="col-lg-5 col-md-5">
                     <div class="home__contact--info">
                         <div class="home__contact--info__items flex">
                             <div class="home__contact--info__icon ml-4">
                             ...
                             <div class="contact__info--content">
                                 <h3 class="contact__info--content__title ">العنوان</h3>
                                 <p class="contact__info--content__desc  mt-4"> حى الظهرة - شارع الملك فهد</p>
                             </div>
                         </div>
                         <div class="home__contact--info__items d-flex">
                             ...
                             <div class="contact__info--content">
                                 <h3 class="contact__info--content__title">التليفون</h3>
                                 <p class="contact__info--content__desc  mt-4"><a
                                         href="tel:+01234-567890">+01234-567890</a> <br> <a
                         ...
                         <div class="home__contact--info__items d-flex">
                             ...
                             <div class="contact__info--content">
                                 <h3 class="contact__info--content__title">البريد الإلكتروني</h3>
                                 <p class="contact__info--content__desc mt-4"> <a
                 ...
                 <div class="col-lg-7 col-md-7">
                     <div class="home__contact--map">
                         <iframe scrolling="no" marginheight="0" marginwidth="0"
                             src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=+(My%20Busin%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9%20%D9%84%D9%84%D8%B9%D9%88%D8%AF%20Arabian%20Oudess%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                             width="600" height="380" frameborder="0" allowfullscreen="" loading="lazy">
                         </iframe>
                     </div>
                 </div>
             </div>
